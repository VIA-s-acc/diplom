...
field.randomize_field(0.0,0.2)
field.set_road(road_row)




water_machine = WateringMachine(max_speed_mps=1, water_per_sec=0.15, watering_coeff = 1, rad_x_m=0.5, rad_y_m=50, max_water_level=1.0, field=field, METRIC=Metrics.SOYBEAN, delta_t=0.1)
time_intervals, analys = water_machine.water_field(road_row, visualize=True, anim_speed = 10)
